...
public class Hepsiburada {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        WebElement xxx=driver.findElement(By.xpath("//label[@class='horizontalSortingBar-Ce404X9mUYVCRa5bjV4D']"));
        xxx.click();
        ...
        for (String pencere : tumPencereler) {
            if (!pencere.equalsIgnoreCase(anaPencere)) {
